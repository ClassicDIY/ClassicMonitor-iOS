...
open class GaugeViewFloat: UIView {
    ...
    public weak var delegate: GaugeViewFloatDelegate? = nil
    ...
    override open func draw(_ rect: CGRect) {
            ...
            for i in 0...numOfDivisions {
                if i != numOfDivisions && numOfSubDivisions != 0 {
                    for j in 0...numOfSubDivisions {
                        ...
                        context?.drawDotFloat(center: point,
        ...
        minValueLabel.text = String(format: "%.1f", minValue)
        ...
        maxValueLabel.text = String(format: "%.1f", maxValue)
    ...
    public func strokeGauge() {
        ...
        if let delegate = delegate {
            ringColor = delegate.ringStokeColorFloat(gaugeView: self, value: value)
        }
...
extension CGContext {
    func drawDotFloat(center: CGPoint, radius: Double, fillColor: UIColor) {
        beginPath()
